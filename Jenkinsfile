pipeline {
  ...
  environment {
    ...
    CI_SSL = 'false'
    CI_DELAY = '30'
    CI_DOCKERENV = 'TEST_RUN=true|NEXTAUTH_SECRET=secret'
    CI_AUTH = ''
    CI_WEBPATH = ''
  }
  stages {
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-ai-chat-app/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-ai-chat-app\" \
          ...
          --label \"org.opencontainers.image.description=ai-chat-app - Open Source, Self-Hosted ChatGPT app\" \
